#!/usr/bin/env python3
# Author ID: Shermalyn Andon - 160564217

class Student:
    # Define the name and number when a student object is created
    def __init__(self, name, number):
        self.name = name
        self.number = str(number)  # Ensure number is a string to prevent TypeError
        self.courses = {}
    ...
    def displayGPA(self):
        if len(self.courses) == 0:  # Check for division by zero
